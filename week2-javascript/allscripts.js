...
const b1 = new Set([3, 4, 5, 6]);

// Union of a and b
const union = new Set([...a1, ...b1]);
console.log(union); // Set { 4, 5, 1, 2, 3, 6}
...
//         Name: ahladita
//         Total Income: 120000000
//         Total Expense: 12000000
...
// //output
// {"firstName":"hari","lastName":"ram","age":20,"isMarried":false,"skills":["HTML","CSS","JS","React","Node","Python"]}
...
const studentSubset = {
  ...
  //output{"firstName":"hari","lastName":"ram","skills":["HTML","CSS","JS","React","Node","Python"]}